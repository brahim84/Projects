...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Role Menu'), array('action' => 'delete', $roleMenu['RoleMenu']['id']), null, __('Are you sure you want to delete # %s?', $roleMenu['RoleMenu']['id'])); ?> </li>
