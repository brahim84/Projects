...
<?php echo $this->Form->create('PromocodeUser'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Promocode User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PromocodeUser.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PromocodeUser.id'))); ?></li>
