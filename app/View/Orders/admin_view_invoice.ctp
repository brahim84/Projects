...
<head>
	...
	<body width="100%" style="margin: 0; mso-line-height-rule: exactly;">
		<div style="float:left;border: 1px solid grey;padding:10px;">
							...
							<tr>
								...
								<td width="40%" class="stack-column-center">
									<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td dir="ltr" valign="top" class="center-on-narrow">
											<img src="https://apps.time.com.my/dealer/images/dealer_logo.jpg" width="217"></td>
										</tr>									
										<tr>
											<td dir="ltr" valign="top" class="center-on-narrow"><font face="Arial" size="3" color="#000000">CASH TAX INVOICE</font></td>
										</tr>
									</table>
								</td>
								<!-- Column : END -->
								...
								<td width="40%" class="stack-column-center" >
									<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										<tr>
											...
											<td align="left" dir="ltr" valign="top" ><?php echo date('d/M/Y',strtotime($order['Order']['created'])); ?></td>
										</tr>										
									</table>
								</td>
								<!-- Column : END -->
									...
									<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											...
											<font face="Arial" size="2" color="#000000">
												<?php echo $order['User']['title'].' '.$order['User']['name']; ?><br />										
												<?php echo $order['User']['address']; ?><br />
												<?php echo $order['User']['city']; ?><br />
												<?php echo $order['User']['state']; ?><br />
												<?php echo $order['User']['postcode']; ?><br />
			...
			<button class="btn btn-primary hidden-print" onclick="javascript:window.print();"><span class="glyphicon glyphicon-print" ></span> Print</button>
			</div>
		</div>
	</body>
</html>
