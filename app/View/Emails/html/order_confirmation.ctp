...
<p> Dear <?php echo $this->Session->read('Auth.User.User.title').' '.$this->Session->read('Auth.User.User.name'); ?>,</p>
<p> Your Order #<?php echo $order['Order']['id']; ?> has been placed on <?php echo $order['Order']['created']; ?> via TIME dotCom Dealer Portal.</p>
