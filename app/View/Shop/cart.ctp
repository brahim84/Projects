...
<hr>
	...
	<?php foreach ($shop['OrderItem'] as $item): ?>
		<div class="row" id="row-<?php echo $item['Product']['id']; ?>">
			<div class="span1">
			<img class="px60" src="<?php echo $item['Product']['image']; ?>" alt="<?php echo $item['Product']['name']; ?>" />
			</div>
			<div class="span6"><strong><?php echo $this->Html->link($item['Product']['name'], array('controller' => 'products', 'action' => 'view', 'slug' => $item['Product']['id'])); ?></strong></div>
			<div class="span1" id="price-<?php echo $item['Product']['id']; ?>"><?php echo $item['Product']['price']; ?></div>
			<div class="span1">
			<?php 
			echo $this->Form->input('quantity-' . $item['Product']['id'], array('div' => false, 'class' => 'numeric span1', 'label' => false, 'data-id' => $item['Product']['id'], 'value' => $item['quantity'])); 
	...
	<div class="row">
		<div class="span6 offset6 tr">
			<?php
			echo $this->Form->input('promocode', array('div' => false, 'data-id' => $item['Product']['id'], 'class' => 'promocode span1', 'label' => 'Apply Promocode')); 
			echo $this->Form->input('promocode_id', array('div' => false, 'type' => 'hidden')); 
			
			?>
			<div id="promo_error" class="error" style="display:none;"></div>
		</div>
	...
	<div class="row">
		<div class="span3 offset9 tr">
			<br />
			Subtotal: <span class="normal" id="subtotal">RM <?php echo $shop['Order']['subtotal']; ?></span>
			<br />
			Discount: <span class="red" id="discount">RM <?php echo $shop['Order']['discount']; ?></span>
			<br />
			Order Total: <span class="red" id="total">RM <?php echo $shop['Order']['total']; ?></span>
			<br />
