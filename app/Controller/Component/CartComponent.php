...
//////////////////////////////////////////////////
	...
	public function add($id, $quantity = 1, $discount = 0,$promocode_id = 0) {
...
/* 		if($quantity > $this->maxQuantity) {
		...
		if($promocode_id >0)
			$this->Session->write('Shop.Order.promocode_id',$promocode_id);
		...
		$cartdata['Cart']['discount'] = $discount;
...
//////////////////////////////////////////////////
	...
	public function cart() {
		...
		if (count($shop['OrderItem']) > 0) {
			...
			$d['total'] = sprintf('%01.2f', $total)- $this->Session->read('Shop.Order.discount');
			$d['discount'] = $this->Session->read('Shop.Order.discount');
